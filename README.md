...
<p align="center">
  <a href="https://github.com/v2rayA/v2raya.github.io/blob/master/LICENSE">
    <img src="https://img.shields.io/github/license/h-enk/doks?style=flat-square" alt="GitHub">
  </a>
  <a href="https://github.com/v2rayA/v2raya.github.io/releases">
  ...
  <a href="https://github.com/v2rayA/v2raya.github.io/actions?query=workflow%3A%22Hyas+CI%22">
...
```bash
git clone https://github.com/v2rayA/v2raya.github.io-child-theme.git my-doks-site && cd my-doks-site
```

#### Doks starter theme

```bash
git clone https://github.com/v2rayA/v2raya.github.io.git my-doks-site && cd my-doks-site
```
...
- [Doks Discussions](https://github.com/v2rayA/v2raya.github.io/discussions)
